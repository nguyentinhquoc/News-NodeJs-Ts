...
import {
  listComments,
  listCommentsDelete
} from '../controllers/admin/comments-admin-controller'
...
const routerWeb = (app: Express) => {
  ...
  app.put(
    '/admin/edit-news/:slug',
    Authentication,
    Authorization,
    editNewsPost
  )
  app.delete('/admin/delete-news/:slug', Authentication, Authorization, deleteNews)
  // <+==================== News====================+>
  ...
  app.put('/changeStatus', Authentication, Authorization, changeStatusC)
  app.put('/changeRole', Authentication, Authorization, changeRoleC)
